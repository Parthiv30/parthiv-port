                ...
                >
                    ...
                    <div className="flex justify-center lg:justify-start space-x-4">
                      {[
                        ...
                        <motion.a
                          ...
                          whileTap={{ scale: 0.95 }}
                          className={`w-14 h-14 ${
                            isDarkMode ? "bg-slate-800/50 border-slate-700/50" : "bg-white/50 border-gray-200/50"
                          } backdrop-blur-sm rounded-full border hover:border-${social.color}-500/50 hover:bg-${
                            social.color
                          }-500/10 flex items-center justify-center transition-all duration-300 group`}
                        >
                          <social.icon
                            size={24}
                            className={`${isDarkMode ? "text-gray-300" : "text-gray-600"} group-hover:text-${
                              social.color
                  ...
                  >
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => (window.location.href = "mailto:parthivshingala@gmail.com")}
