...
// Import icons
import {
  SiReact, SiTailwindcss, SiNodedotjs, SiExpress, SiMongodb, SiPhp,
  SiMysql, SiFirebase, SiSap, SiJavascript, SiCplusplus, SiJquery,
  SiBootstrap, SiHtml5, SiCss3, SiDotnet, SiOracle, SiAngular,
  SiFramer, SiCloudinary, SiPostman,
  SiFigma, SiGit, SiGithub, SiNetlify, SiVercel, SiRender, SiAndroidstudio,SiCoursera ,SiLinkedin
} from "react-icons/si";
...
const particlesConfig = {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col lg:flex-row items-center gap-16">
                ...
                >
                  ...
                  >
                    {[
                      { href: "https://github.com/Parthiv30", icon: SiGithub },
                      {
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      . During this internship, I gained hands-on experience
                      with industry-relevant skills such as business process
 ...
 <motion.h2
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.3 }}
                  className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-8 font-tangerine"
                >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <motion.p
                  ...
                  style={{ fontFamily: "'Poppins', sans-serif" }}
                >
                  "Open for freelance projects, collaborations, or just a
                  friendly chat."
                </motion.p>
              </motion.div>
